...
static const int LAST_POW_BLOCK = 180000;	// estimated to be about 60 days
...
static const double TAXATION_PERCENTAGE = 0.015;
static const int64_t MAX_MINT_PROOF_OF_STAKE_STABLE = 0.02 * COIN;	
...
static const uint256 hashGenesisBlock("000001a09821dc0a6d33a76a18dc3fcfa9b7c2c2cf5fd7a7ccf473e9a934924d");
static const uint256 hashGenesisBlockTestNet("000001a09821dc0a6d33a76a18dc3fcfa9b7c2c2cf5fd7a7ccf473e9a934924d");
...
public:
    ...
    {
        // MammothCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // MammothCoin: get transaction coin age
...
public:
    ...
    // MammothCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // MammothCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MammothCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // MammothCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // MammothCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // MammothCoin: block index flags
    enum  
    {
